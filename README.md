...
## Citation
```sh
@inproceedings{tamo2024heterogeneous,
  title={Heterogeneous Treatment Effects of Spinal Fusion Surgery for Adolescent Idiopathic Scoliosis Patients},
  author={Tamo, J Ben and Nnamdi, Micky C and Hornback, Andrew and Chen, Matthew and Shi, Wenqi and Zhu, Yuanda and Iwinski, Henry J and Wang, May D},
